    ...
    <div class="content-center">
        ...
        <div class="py-6 px-1 md:px-2 lg:px-6">
            ...
            <form id="authenticate_form"
                  ...
                  action="{{ route('nova-two-factor.auth') }}">
                @csrf
                <h2 class="text-2xl text-center font-normal mb-6 text-90">{{ __('Two factor authentication') }}</h2>
                <svg class="block mx-auto mb-6"
                     xmlns="http://www.w3.org/2000/svg"
                     width="100"
                     height="2"
                     viewBox="0 0 100 2">
                    <path fill="#D8E3EC"
                          d="M0 0h100v2H0z"></path>
                </svg>


                <div class="mb-6"><label class="block font-bold mb-2"
                           for="otp">{{ __('One time password') }}</label>
                    <input onkeyup="checkAutoSubmit(this)"
                           autofocus
